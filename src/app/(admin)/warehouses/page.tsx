      ...
      <div className="page-container pt-6">
        ...
        <div className="mt-8 flex flex-col items-center justify-start gap-4 p-4">
          {warehouses?.map((warehouse: any) => (
            <Card
              key={warehouse.id}
              className="flex w-full flex-col rounded-lg bg-white p-4 shadow-md md:w-4/5 md:flex-row"
            >
              ...
              <CardContent className="h-[400px] w-[600px]">
                <iframe
                  width="100%"
                  height="100%"
                  loading="lazy"
                  ...
                  src={`https://www.google.com/maps/embed/v1/place?key=${process.env.GOOGLE_MAPS_API}&q=${warehouse.address}`}
                ></iframe>
              </CardContent>
            </Card>
          ))}
